...
Public Class func_clientes
    ...
    Public Function listar(ByVal sql As String) As DataTable
        ...
        Catch ex As Exception
            util.mensajes("Error al listar Clientes: " + ex.Message, "func_clientes")
            Return Nothing
        Finally
            desconectar()
        End Try
    ...
    Public Function insertar(ByVal nombres As String, ByVal apellidos As String, ByVal nro_documento As String, ByVal telefono As String,
        ...
        Try
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al registrar Cliente: " + ex.Message, "func_clientes")
            Return False
        Finally
            desconectar()
        End Try
    ...
    Public Function actualizar(ByVal nombres As String, ByVal apellidos As String, ByVal nro_documento As String, ByVal telefono As String,
        ...
        Try
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al actualizar Cliente: " + ex.Message, "func_clientes")
            Return False
        Finally
            desconectar()
        End Try
    ...
    Public Function eliminar(ByVal id_cliente As Integer) As Boolean
        Try
            ...
            End If
        Catch ex As Exception
            util.mensajes("Error al eliminar Cliente: " + ex.Message, "func_clientes")
            Return False
        Finally
            desconectar()
        End Try
